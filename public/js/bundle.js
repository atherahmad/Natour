...
if (userDataForm) userDataForm.addEventListener("submit", function (e) {
  ...
  (0, _updateSettings.updateData)(name, email); // we pass in our updateData function (which will connect and send this updated data to the backend).Backendcontroller will update DB
});
